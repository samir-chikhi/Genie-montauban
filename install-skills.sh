...
# SEO marketing : audit complet, référencement dans les IA (llms.txt),
# données structurées (LocalBusiness, Course, Event), conversion des pages
# tarifs/inscription, architecture et maillage interne du site
npx -y skills add coreyhaines31/marketingskills -s seo-audit -s ai-seo -s schema -s cro -s site-architecture -a claude-code -g -y
